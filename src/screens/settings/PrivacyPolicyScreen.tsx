      ...
      <ScrollView>
        ...
        <View style={styles(theme).container}>
          <Text>
            ...
            our Terms and Conditions, which are accessible at ReportApp unless
            ...
            information, including but not limited to ReportApp. The information
            ...
            collect information used to identify you. Link to the privacy policy
            of third-party service providers used by the app - [Google Play
            Services](https://www.google.com/policies/privacy/) -
            [Expo](https://expo.io/privacy) # **Log Data** I want to inform you
            ...
            use some portions of this Service. # **Service Providers** I may
            employ third-party companies and individuals due to the following
            reasons: - To facilitate our Service; - To provide the Service on
            our behalf; - To perform Service-related services; or - To assist us
            ...
            guarantee its absolute security. # **Links to Other Sites** This
            ...
            **Children’s Privacy** These Services do not address anyone under
            the age of 13. I do not knowingly collect personally identifiable
            ...
            this page. This policy is effective as of 2023-01-23 # **Contact
            Us** If you have any questions or suggestions about my Privacy
            Policy, do not hesitate to contact me at info.reportapp@gmail.com.
          </Text>
        </View>
      </ScrollView>
    </ScreenSafeAreaContainer>
